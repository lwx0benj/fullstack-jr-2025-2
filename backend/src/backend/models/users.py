...
from sqlalchemy.orm import Mapped, mapped_as_dataclass, mapped_column, relationship, registry
...
class Task:
    ...
    __table_args__ = (
        Index("ix_tasks_status_priority", "status", "priority"),  # ajuste o nome conforme o teste
    )
